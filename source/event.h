#ifndef FUNGUS2D_EVENT_H
#define FUNGUS2D_EVENT_H
...
namespace Fungus2D
{
    ...
    namespace detail
    {
        ...
        private:
            ...
            template <typename, size_t> friend class util::block_allocator;
    ...
    private:
        ...
        util::block_allocator<subsbase_type, 512> s_blocks;
